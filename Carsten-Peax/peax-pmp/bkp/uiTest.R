...
#             accept=c('text/csv', 'text/comma-separated-values,text/plain'))),
  ...
  conditionalPanel(condition="input.tabSelected=='Pheno Tree'",
	...
	fluidRow(
	     div(class="row-fluid",align="left",style="float:left;margin-left:0px",
        column(3,plotOutput("mirPlot1",height="250px",width="400px")),
        column(3,plotOutput("mirPlot2",height="250px",width="400px")),
        column(3,plotOutput("mirPlot3",height="250px",width="400px")),
        column(3,plotOutput("mirPlot4",height="250px",width="400px")
 		))),
	fluidRow(
	    div(class="row-fluid",align="left",style="float:left;margin-left:0px",
	        column(3,plotOutput("Plot1",height="250px",width="400px")),
	        column(3,plotOutput("Plot2",height="250px",width="400px")),
	        column(3,plotOutput("Plot3",height="250px",width="400px")),
	        column(3,plotOutput("Plot4",height="250px",width="400px")
	        )))
  ))
